  ...
  new: [
    {
      ...
      img: 'img/mint.png',
      art: '양치의 호흡',
      desc: '배그로 방송을 시작한 반올림하면 2m인 배그 요정.',
      keywords: '#밍구단 #치약 #왕대두',
      birthday: '06.16',
      mbti: 'ISFJ',
      tmi: '무한성 OTT 대기 중인 낯가림 심한 요정 <br>배그하다 스페이스바 부순 전적 보유',
      color: '#00C9A7',
    ...
    },
    {
      ...
      birthday: '12.06',
      mbti: 'ENFJ',
      tmi: '방송-씻기-잠의 무한 굴레에 빠진 스트리밍 중독자 <br> 미나리와 공겜을 극도로 혐오함.',
      color: '#FFB6C1',
    ...
    },
    {
      ...
      img: 'img/tami.png',
      art: '윤타미의 호흡',
      desc: '모든 게임 최상위권 티어를 보유한 피지컬 괴물. (LOL 다이아, 롤체 마스터, 발로 불멸)',
      keywords: '#탐정단 #탐xx #종합게임고수',
      birthday: '09.16',
      mbti: 'ENFJ',
      tmi: '피구·밴드·연극부 단장 출신 인싸.<br> 밥 대신 아샷추 1리터를 마심.',
      color: '#87CEEB',
    ...
    },
    {
      ...
      img: 'img/moya.png',
      art: '표독한 수은',
      desc: '피지컬이 좋고 게임 적응력이 빠른 다재다능한 혈귀.',
      keywords: '#먀우 #표수 #꾸야',
      birthday: '09.08',
      mbti: 'ESFP',
      tmi: '목소리 톤은 높지만 체력이 약해 졸리면 잔잔해짐.<br>질투심 많은 꾸잔 바라기.',
      color: '#fce17e',
    ...
    },
    {
      ...
      img: 'img/sosim.jpeg',
      art: '또띠아 소환',
      desc: '목소리 크고 씩씩하지만 게임 빼고는 다 할머니인 잼민이 혈귀.',
      keywords: '#히노눙눙이 #대담해 #과감해',
      birthday: '08.19',
      mbti: 'INFJ',
      tmi: '어릴 때 감나무에서 떨어진 이후 씩씩해짐. <br>영타 70타 미만에 꾸잔을 좋아함.',
      color: '#EADDE2',
