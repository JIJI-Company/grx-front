export default async (req, context) => {
  ...
  // 최신 GAS 웹 앱 URL (V5 - 15분 사이클 버전)
  const STOCK_GAS_URL = "https://script.google.com/macros/s/AKfycbxCFSaqIrU5vpH310erJTho9Y-UuPlDqUoWPqayHFcXy3n1uJKWZvSEUzD1RwJW_INuUw/exec";
